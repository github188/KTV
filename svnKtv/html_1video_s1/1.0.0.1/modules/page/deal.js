    ...
    Deal.prototype.notTemplate=function($div,result){
        ...
        $(result).each(function(i){
            ...
            html+= "<li id="+ data["ID"]+" class='img' cmd='"+data.ParentId+"'"+
                "title='"+data.PropsTooltip + "'><object id='"+ self.giftType+data["ID"] +"' type='application/x-shockwave-flash' data='"+data.PropsIco + "'play='false' width='40' height='40'><param name='wmode' value='transparent' /></object><p>"+data.PropsName+"</p></li>";
        });
        $div.html(html);
    }
