...
//BigCaseId, CaseId, ParentId, ChildId, des, extparam, serUrl, callBack, type, targUin, callBackId, callback, arg
//{"param":{"BigCaseId":10001,"CaseId":10027,"ParentId":10072,"ChildId":102,"Uin":"admin@aodiansoft.com","SessionKey":"123456",
// "ChannelId":"5880153","GroupId":"","TargetUin":"123456","Client":"WEB Client","DoingWeight":"1","MoneyWeight":"1","Desc":"Test Platform"},"extparam":{"Tag":"EditNick","Nick":"test"}}
serverMsgManager.prototype.changeNick =function(callback, arg,nick) {
    this._reqAJX(10001,10027,10072,102,"Test Platform",{"Tag":"EditNick","Nick":nick},this.m_url,callback,"","123456", "changeNick", callback, arg);
}
...
serverMsgManager.prototype.GetCollectRoom = function(callback, arg) {	// 是否已经收藏房间
    this._reqAJX(10004,10019,10574,101,"get collectionRoom",{Tag:"GetCollect"},this.m_url,callback,"",null,"GetCollectRoom", callback, arg);
}
...
serverMsgManager.prototype.CancelCollectRoom = function(callback, arg) {
    this._reqAJX(10004,10019,10574,103,"cancel collectionRoom",{Tag:"CancelRoom"},this.m_url,callback,"",null,"CancelCollectRoom", callback, arg);
}
...
serverMsgManager.prototype._reqAJX = function(BigCaseId, CaseId, ParentId, ChildId, des, extparam, serUrl, callBack, type, targUin, callBackId, callback, arg) {
	...
	if(this.m_url == null) {
		this.m_url ="http://777888.test.vvku.com/data/index.php";
	}
